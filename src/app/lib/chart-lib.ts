...
export const common_dataset_props = { borderWidth: 1, pointRadius: 0, tension: 0.2, fill: true }

export const common_chart_options: import('chart.js').ChartOptions<'line'> = {
    responsive: true,
        ...
        y: {
            ...
            ticks: {
                callback(tickValue: number | string) {
                    return pretty_bytes(+tickValue) + '/s '
                },
            },
        },
    },
